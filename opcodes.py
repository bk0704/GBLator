...
# LD A, r8
ops_base[0x78] = {"mnemonic": "LD A, B", "handler": ld_a_b, "length": 1, "cycles": 4,}
ops_base[0x79] = {"mnemonic": "LD A, C", "handler": ld_a_c, "length": 1, "cycles": 4,}
ops_base[0x7A] = {"mnemonic": "LD A, D", "handler": ld_a_d, "length": 1, "cycles": 4,}
ops_base[0x7B] = {"mnemonic": "LD A, E", "handler": ld_a_e, "length": 1, "cycles": 4,}
ops_base[0x7C] = {"mnemonic": "LD A, H", "handler": ld_a_h, "length": 1, "cycles": 4,}
ops_base[0x7D] = {"mnemonic": "LD A, L", "handler": ld_a_l, "length": 1, "cycles": 4,}
ops_base[0x7F] = {"mnemonic": "LD A, A", "handler": ld_a_a, "length": 1, "cycles": 4,}

# LD r8, [HL]
ops_base[0x46] = {"mnemonic": "LD B,[HL]", "handler": ld_b_hl, "length": 1, "cycles": 8,}
ops_base[0x4E] = {"mnemonic": "LD C,[HL]", "handler": ld_c_hl, "length": 1, "cycles": 8,}
ops_base[0x56] = {"mnemonic": "LD D,[HL]", "handler": ld_d_hl, "length": 1, "cycles": 8,}
ops_base[0x5E] = {"mnemonic": "LD E,[HL]", "handler": ld_e_hl, "length": 1, "cycles": 8,}
ops_base[0x66] = {"mnemonic": "LD H,[HL]", "handler": ld_h_hl, "length": 1, "cycles": 8,}
ops_base[0x6E] = {"mnemonic": "LD L,[HL]", "handler": ld_l_hl, "length": 1, "cycles": 8,}
ops_base[0x7E] = {"mnemonic": "LD A,[HL]", "handler": ld_a_hl, "length": 1, "cycles": 8,}

# LD [HL], r8
ops_base[0x70] = {"mnemonic": "LD [HL],B", "handler": ld_hl_b, "length": 1, "cycles": 8}
ops_base[0x71] = {"mnemonic": "LD [HL],C", "handler": ld_hl_c, "length": 1, "cycles": 8}
ops_base[0x72] = {"mnemonic": "LD [HL],D", "handler": ld_hl_d, "length": 1, "cycles": 8}
ops_base[0x73] = {"mnemonic": "LD [HL],E", "handler": ld_hl_e, "length": 1, "cycles": 8}
ops_base[0x74] = {"mnemonic": "LD [HL],H", "handler": ld_hl_h, "length": 1, "cycles": 8}
ops_base[0x75] = {"mnemonic": "LD [HL],L", "handler": ld_hl_l, "length": 1, "cycles": 8}
ops_base[0x77] = {"mnemonic": "LD [HL],A", "handler": ld_hl_a, "length": 1, "cycles": 8}

# LD r16, n16
ops_base[0x01] = {"mnemonic": "LD BC,n16", "handler": ld_bc_n16, "length": 3, "cycles": 12,}
ops_base[0x11] = {"mnemonic": "LD DE,n16", "handler": ld_de_n16, "length": 3, "cycles": 12,}
...
# LD [r16], A
ops_base[0x02] = {"mnemonic": "LD [BC],A", "handler": ld_bc_a, "length": 1, "cycles": 8,}
ops_base[0x12] = {"mnemonic": "LD [DE],A", "handler": ld_de_a, "length": 1, "cycles": 8,}

# LD A, [r16]
ops_base[0x0A] = {"mnemonic": "LD A,[BC]", "handler": ld_a_bc, "length": 1, "cycles": 8,}
ops_base[0x1A] = {"mnemonic": "LD A,[DE]", "handler": ld_a_de, "length": 1, "cycles": 8,}

# LD [HL+/-], A
ops_base[0x22] = {"mnemonic": "LD [HL+],A", "handler": ld_hl_plus_a, "length": 1, "cycles": 8,}
ops_base[0x32] = {"mnemonic": "LD [HL-],A", "handler": ld_hl_minus_a, "length": 1, "cycles": 8,}
